#ifndef weightSusaValenciaClass_h
#define weightSusaValenciaClass_h
//#endif
...
namespace PlotUtils{
	...
	public:
	  ...
	  weightSusaValenciaClass(const TString  f) { read(f); }    //Read in params from file
	  ...
	  double getWeightMeV(const double mc_q0, const double mc_q3, const int mode=0) const; //in GeV
	  double getWeight(const double mc_q0, const double mc_q3, const int mode=0) const; //in GeV
	  //Initializer
	  ...
	  double getWeightInternal(const double mc_q0, const double mc_q3, const int mode) const;
